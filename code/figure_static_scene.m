...
for l=1:4
	for n=1:2
		...
		for i=1:num_psf
			imwrite(input_img{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_input_img.png'])
			imwrite(true_img{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_true_img.png'])
			imwrite(output_img{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_output_img.png'])
% 			imwrite(lowrank_img{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_lowrank_img.png'])
% 			imwrite(sparsity_img{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_sparsity_img.png'])
			imwrite(true_psf{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_true_psf.png'])
			imwrite(output_psf{i},['presentation\static\' num2str(l) '_' num2str((n-1)*4+i) '_output_psf.png'])
		end
	end
end